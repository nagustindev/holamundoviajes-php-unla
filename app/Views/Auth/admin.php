...
<body>
    <!-- Toasts Container -->
    <div id="toast-container" class="fixed top-4 right-4 z-[99999] space-y-4">
        <!-- Toast de Éxito -->
        <?php if (session()->getFlashdata('success')): ?>
            <div id="toast-success" class="flex items-center w-full max-w-md p-4 text-gray-500 bg-white rounded-lg shadow-lg" role="alert">
        ...
        <?php if (session()->getFlashdata('error')): ?>
            <div id="toast-danger" class="flex items-center w-full max-w-md p-4 text-gray-500 bg-white rounded-lg shadow-lg" role="alert">
